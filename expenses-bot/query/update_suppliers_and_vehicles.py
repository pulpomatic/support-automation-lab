...
def load_rl_enum(file_path):
    ...
    with open(file_path, mode='r') as file:
        ...
        for row in reader:
            ...
            vehicle_name = clean_vehicle_name(row['name'])  # Limpieza de la matrícula
            supplier = capitalize_supplier_name(row['supplier'])  # Formateo del proveedor
...
if __name__ == "__main__":
    account_id = 297525
    rl_enum_file = 'expenses_file.csv'  # Ruta del archivo CSV
